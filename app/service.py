...
def create_promotions():
    ...
    location_url = url_for('get_promotions', promotion_id=productid, _external=True)
...
######################################################################
@app.route('/promotions/product/<int:productid>', methods=['GET'])
def get_promotions(productid):
    """
